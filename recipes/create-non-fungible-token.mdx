...
description: "Learn how to create a non-fungible token"
---
...
<Info> Non-fungible contracts allow multiples item types</Info>
...
```javascript JavaScript
axios
  .post("https://protocol.lumx.io/v1/item-types", {
    contractId: "<CONTRACT_ID>",
    description: "My first item type",
    name: "First item type",
    price: 0,
