...
The staging environment allows you to experience all of Lumx Protocol services on the testnet/devnet. It serves as a sandbox or simulated environment where developers, testers, and other stakeholders can experiment, validate, and evaluate various features and functionalities of Lumx Protocol before deploying them to the mainnet or production environment. Use the following URL to the access staging eviroment:

```
https://protocol-staging.int.lumx.io/v1
```
