...
<Info>
  You can do that right now! [Check our "Mint a token" recipe](/recipes/mint-tokens).
</Info>
...
<Info>
  Every transaction on the Protocol is queued up! [Check our "Mint tokens" recipe](/recipes/mint-tokens).
</Info>
